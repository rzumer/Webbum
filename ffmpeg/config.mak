...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--toolchain=msvc --enable-shared
prefix=/usr/local
...
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 18.00.31101 for x86
ARCH=x86
INTRINSICS=none
CC=cl
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -Dsnprintf=avpriv_snprintf -D_snprintf=avpriv_snprintf -Dvsnprintf=avpriv_vsnprintf -D_WIN32_WINNT=0x0502
CFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS    -Z7 -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O2   -Oy- -Dinline=__inline
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS  -Z7
AS_C=-c
AS_O=-Fo$@
CC_C=-c
CC_E=-P -Fi$@
...
HOSTCC=cl
HOSTLD=cl
HOSTCFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS  -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O3 -Dinline=__inline
HOSTCPPFLAGS= -D_ISOC99_SOURCE -Dsnprintf=_snprintf -D_WIN32_WINNT=0x0502
HOSTEXESUF=
HOSTLDFLAGS= -nologo
HOSTLIBS=-lm
DEPHOSTCC=cl
...
EXTRALIBS=vfw32.lib user32.lib gdi32.lib psapi.lib ole32.lib strmiids.lib uuid.lib oleaut32.lib shlwapi.lib ws2_32.lib psapi.lib advapi32.lib shell32.lib 
...
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=ole32.lib user32.lib
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
!ARCH_ARM=yes
!ARCH_AVR32=yes
